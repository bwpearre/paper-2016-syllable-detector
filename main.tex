...
\begin{figure}
  ...
  \caption{The spectrogram of the song of lny64, used as an example
...
for which extending the window to 80 ms is very helpful.
...
as $t^*_1\ldots t^*_6$ respectively.  For clarity, the rectangles show
...
lny46 & 	140 & 	99.53 & 	0.0041 \\ % /Volumes/Data/song/lny46/confusion_log_perf.txt          
lny4rb & 	250 & 	99.36 & 	0.0025 \\ % /Volumes/Data/song/lny4rb/confusion_log_perf.txt        

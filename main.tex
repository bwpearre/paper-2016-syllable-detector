...
chart in \fig{fig:accuracies}, and the means are shown in Table~\ref{table:accuracies}.  Some syllables are easier to identify
reliably than others, showing that detection point choice can impact the
detector's accuracy.  As can be seen from \fig{fig:accuracies}, for difficult syllables, the training process

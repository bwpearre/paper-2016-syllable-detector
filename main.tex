...
Data consisted of extracted, aligned songs, and additional song-length samples of non-song (cage noise, calls, other birds' song). These were divided into training and test sets. For Bird A, we used 1000 songs and 1000 non-song samples for training, and the remaining 1818 songs and 3636 nonsongs for testing. For birds B, C, and D, we used 1000 songs and 1000 non-songs for training, and another 1000 of each for testing.

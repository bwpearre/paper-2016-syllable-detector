...
indicated by the red lines, and for convenience will be referred to
henceforth as $t^*_1\ldots t^*_6$ respectively.  For clarity, the
rectangles show a shorter recognition window than our standard: here
30 ms, but still spanning 1--8 kHz, for each target time in the
song.\marginpar{Is this OK?  Should I update to a 50-ms window?
  They'll overlap.}

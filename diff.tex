...
%DIF ADD main.tex                                                          Mon Mar 20 16:58:01 2017
...
played a disruptive sound during renditions
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Keller2009}}%DIFAUXCMD
.  Renditions }\DIFaddend of a syllable that
were \DIFaddbegin \DIFadd{disrupted by white noise when they were }\DIFaddend slightly above (or below)
\DIFdelbegin \DIFdel{its average pitch ,
and }\DIFdelend \DIFaddbegin \DIFadd{the syllable's average pitch }\DIFaddend showed that the \DIFdelbegin \DIFdel{presence of this }\DIFdelend apparently random natural
...
\cite{Tumer2007pitchshift}}%DIFAUXCMD
. Furthermore, }\DIFaddend AFP produces a
...
and \DIFdelbegin \DIFdel{they did not report on }\DIFdelend jitter or accuracy \DIFaddbegin \DIFadd{were not reported}\DIFaddend .  As access to
...
\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Keller2009} }%DIFAUXCMD
applied }\DIFdelend \DIFaddbegin \DIFadd{2009 also saw the application of }\DIFaddend a neural network to a spectral image of
...
\begin{enumerate}
\item Record and align a corpus of training songs.  The technique has been published in \cite{Poole2012}. \DIFaddbegin \DIFadd{200 songs generally yield acceptable results, but here we standardise on 1000-song training sets.
...
detector performance, but occasionally a syllable will be seen for
which extending the window to 80 ms is very helpful.
}\DIFaddend 
...
reported in the following section, the training set consisted of }\DIFdelend \DIFaddbegin \begin{table}
 \begin{tabular}{c|ccc}
    \DIFaddFL{Bird }& \DIFaddFL{Test songs }& \DIFaddFL{Test non-songs }& \DIFaddFL{Target time (ms) }\\ \hline
    \DIFaddFL{lny64 }& \DIFaddFL{1818 }& \DIFaddFL{10545 }& \DIFaddFL{150:50:400 }\\
    \DIFaddFL{lny46 }& \DIFaddendFL 1000 \DIFdelbeginFL \DIFdelFL{instances of the song of one bird, and }\DIFdelendFL \DIFaddbeginFL & \DIFaddFL{1000 }& \DIFaddFL{195 }\\
    \DIFaddFL{lny42 }& \DIFaddFL{1245 }& \DIFaddFL{1223 }& \DIFaddFL{380 }\\
    \DIFaddFL{lny4rb }& \DIFaddFL{1000 }& \DIFaddFL{1000 }& \DIFaddFL{250 }\\
    \DIFaddFL{lr12 }& \DIFaddendFL 2000 \DIFaddbeginFL & \DIFaddFL{2008 }& \DIFaddFL{180 }\\
    \DIFaddFL{lr13 }& \DIFaddFL{2000 }& \DIFaddFL{2001 }& \DIFaddFL{300 }\\
    \DIFaddFL{lr28 }& \DIFaddFL{3000 }& \DIFaddFL{3014 }& \DIFaddFL{140 }\\
    \DIFaddFL{lr77 }& \DIFaddFL{2000 }& \DIFaddFL{2008 }& \DIFaddFL{320
  }\end{tabular}
  \caption{\DIFaddFL{For each bird, detectors were trained for the specified
    ...
    length. The rest of the audio samples---shown here---were used to
    test the learned detectors.}}
  \label{table:datasizes}
\end{table}

\DIFadd{Data consisted of extracted, aligned songs, and additional }\DIFaddend song-length
samples of non-song (cage noise, calls, other birds' song). \DIFdelbegin \DIFdel{Our test set
consisted of an additional 1818 iterations of the bird's song and 3636
song-length samples of non-song}\DIFdelend \DIFaddbegin \DIFadd{These were
divided into training and test sets. For all birds, we used 1000 songs
and 1000 non-song samples for training. Table~\ref{table:datasizes}
...
the recognition window (}\DIFdelend \DIFaddbegin \DIFadd{For clarity, the rectangles show
a shorter recognition window than our standard: here }\DIFaddend 30 ms, \DIFaddbegin \DIFadd{but still
spanning }\DIFaddend 1--8 kHz\DIFdelbegin \DIFdel{) for each instant }\DIFdelend \DIFaddbegin \DIFadd{, for each target time }\DIFaddend in the song.\DIFaddbegin \marginpar{Is this
  OK?  Should I update to a 50-ms window?  They'll overlap.}
\DIFaddend 
...
\DIFdelbeginFL \DIFdelFL{$t^*_1$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{lny64 }\DIFaddendFL & 	\DIFdelbeginFL \DIFdelFL{99.34 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{150 $[t^*_1]$ }\DIFaddendFL & 	\DIFdelbeginFL \DIFdelFL{0.0015 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{99.66 }& 	\DIFaddFL{0.0026 }\DIFaddendFL \\ \DIFdelbeginFL \DIFdelFL{$t^*_2$ }\DIFdelendFL %DIF >  /Volumes/Data/song/lny64/confusion_log_perf.txt
  ...
  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{99.52 }& 	\DIFaddFL{0.0010 }\\ %DIF >                                                 
\DIFaddFL{lny42 }& 	\DIFaddFL{380 }& 	\DIFaddFL{99.09 }& 	\DIFaddFL{0.0011 }\\ %DIF >  /Volumes/Data/song/lny42/confusion_log_perf.txt          
\DIFaddFL{lny46 }& 	\DIFaddFL{140 }& 	\DIFaddFL{99.53 }& 	\DIFaddFL{0.0041 }\\ %DIF >  /Volumes/Data/song/lny46/confusion_log_perf.txt          
\DIFaddFL{lny4rb }& 	\DIFaddFL{250 }& 	\DIFaddFL{99.36 }& 	\DIFaddFL{0.0025 }\\ %DIF >  /Volumes/Data/song/lny4rb/confusion_log_perf.txt        
...
computational requirement. We found that some syllables were slightly
easier to detect and some more difficult, with no significant

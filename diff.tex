...
%DIF ADD main.tex          Thu Sep  8 17:02:04 2016
...
We begin with a few hundred recordings of a given bird's song, \DIFdelbegin \DIFdel{in this case }\DIFdelend \DIFaddbegin \DIFadd{as well as calls, cage noise, and other non-song audio data.  Male
...
more commonly studied, as well as more challenging.  Recordings were }\DIFaddend made inside a sound-isolating
chamber in which was mounted a recording microphone (Audio-Technica
AT803).  The songs \DIFdelbegin \DIFdel{are
}\DIFdelend \DIFaddbegin \DIFadd{were }\DIFaddend time-aligned as described in \cite{Poole2012}.
...
\DIFaddend \item[Runtime:]\hfill
  ...
  \item[MATLAB:] {\tt https://github.com/gardner-lab/syllable-detector-matlab}
    ...
    \item[Usage:]\hfill
     ...
     \end{description} 
  \DIFaddend \item[Swift:] {\tt https://github.com/gardner-lab/syllable-detector-swift}
    \DIFaddbegin  \begin{description} 
    \item[Installation:]\hfill
      \begin{trivlist}

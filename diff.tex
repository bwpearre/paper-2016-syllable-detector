...
%DIF ADD main.tex                                                          Tue Mar 21 15:12:34 2017
...
\DIFaddFL{lny46 }&         \DIFaddFL{140 }&   \DIFaddFL{99.17 }&         \DIFaddFL{0.0037 }\\ %DIF >  /Volumes/Data/song/lny46/confusion_log_perf.txt          
...
detector is available under \DIFdelbegin \DIFdel{an open-source license }%DIFDELCMD < {\em %%%
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{the GNU General Public License 3.
...
\DIFdelend \DIFaddbegin \DIFadd{this file }\DIFaddend is specified in {\tt
    ...
    \item \DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin {\tt \DIFadd{learn\_detector}} \DIFadd{also looks in the current directory for
      ...
      parameters at the top of {\tt learn\_detector.m\DIFaddbegin }\DIFadd{.
    }\item \DIFadd{Configuration may also be controlled by specifying
      parameter-value pairs to the function call in the common MATLAB
      fashion; for example, }{\tt
        \DIFadd{learn\_detector('times\_of\_interest\_ms', }[\DIFadd{150 200}]\DIFadd{)}\DIFaddend }.

...
%DIF DEL ../sbpcb/main.tex   Wed Sep  7 17:01:00 2016
%DIF ADD main.tex            Wed Sep  7 17:42:57 2016
...
brain areas concerned with the \DIFdelbegin \DIFdel{acquisition }\DIFdelend \DIFaddbegin \DIFadd{production }\DIFaddend and learning of song.  For
...
\DIFaddend \item[Runtime:]\hfill
  ...
  \DIFaddend \item[Swift:] {\tt https://github.com/gardner-lab/syllable-detector-swift}
    ...
    \item[Customisation:]\hfill
      ...
      }{\tt \DIFadd{Processor}} \DIFadd{class acts as a coordinator, receiving income audio, passing that
